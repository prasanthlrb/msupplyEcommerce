								...
								<table class="table_type_1 orders_table">
									...
									<thead>
										...
										<tr>
											...
											<th class="order_number_col">Booking Number</th>
											<th>Booking Details</th>
											<th class="ship_col">Ship To</th>
											<th>Booking Status</th>
											<th class="order_total_col">Vehicle</th>
										...
										<tr>
											...
											<td data-title="Action">
												<ul class="buttons_col">
													<li>
														<a href="/account/vieworders/{{$order->id}}" class="button_grey">Print Booking Order</a>
													</li>
													<!-- <li>
